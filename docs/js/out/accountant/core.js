...
if(cljs.core.truth_((function (){var and__35486__auto__ = node;
...
var navigation_link_QMARK_ = (function (){var and__35486__auto__ = href;
if(cljs.core.truth_(and__35486__auto__)){
var and__35486__auto____$1 = attrs;
...
if(cljs.core.truth_((function (){var and__35486__auto__ = cljs.core.not.call(null,any_key);
if(and__35486__auto__){
var and__35486__auto____$1 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null).call(null,link_target);
if(cljs.core.truth_(and__35486__auto____$1)){
var and__35486__auto____$2 = cljs.core._EQ_.call(null,button,(0));
if(and__35486__auto____$2){
var and__35486__auto____$3 = cljs.core._EQ_.call(null,host,current_host);
if(and__35486__auto____$3){
var and__35486__auto____$4 = (cljs.core.not.call(null,port)) || (cljs.core._EQ_.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(port)].join(''),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(current_port)].join('')));
if(and__35486__auto____$4){
return path_exists_QMARK_.call(null,path);
} else {
return and__35486__auto____$4;
}
} else {
return and__35486__auto____$3;
}
} else {
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__37813){
...
var nav_handler = cljs.core.get.call(null,map__37814__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.call(null,map__37814__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
...
var params = cljs.core.map.call(null,(function (p1__37816_SHARP_){
return cljs.core.name.call(null,p1__37816_SHARP_);
...
return clojure.string.join.call(null,"=",p1__37817_SHARP_);
});})(params,values,pairs))
,pairs));
});
/**
...
//# sourceMappingURL=core.js.map?rel=1517021941432
