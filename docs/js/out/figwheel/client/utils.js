...
var or__35498__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj44584 = {"detail":data};
return obj44584;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__35486__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__35486__auto__)){
var and__35486__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__44591 = cljs.core._EQ_;
var expr__44592 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__44591.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__44592))){
return ((function (pred__44591,expr__44592){
return (function (p1__44585_SHARP_){
return console.warn(p1__44585_SHARP_);
});
;})(pred__44591,expr__44592))
} else {
if(cljs.core.truth_(pred__44591.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__44592))){
return ((function (pred__44591,expr__44592){
return (function (p1__44586_SHARP_){
return console.debug(p1__44586_SHARP_);
});
;})(pred__44591,expr__44592))
} else {
if(cljs.core.truth_(pred__44591.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__44592))){
return ((function (pred__44591,expr__44592){
return (function (p1__44587_SHARP_){
return console.error(p1__44587_SHARP_);
});
;})(pred__44591,expr__44592))
} else {
return ((function (pred__44591,expr__44592){
return (function (p1__44588_SHARP_){
return console.log(p1__44588_SHARP_);
});
;})(pred__44591,expr__44592))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__44595){
...
var opts = map__44596__$1;
var eval_fn = cljs.core.get.call(null,map__44596__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__44598_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__44600,(0),null);
var v = cljs.core.nth.call(null,vec__44600,(1),null);
...
if(cljs.core.truth_((function (){var and__35486__auto__ = typeof localStorage !== 'undefined';
...
}catch (e44605){if((e44605 instanceof Error)){
var e = e44605;
return not_found;
} else {
throw e44605;
...
//# sourceMappingURL=utils.js.map?rel=1517021947032
