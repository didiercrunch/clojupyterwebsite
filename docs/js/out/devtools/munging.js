...
var o38887 = temp__5455__auto__;
var temp__5455__auto____$1 = (o38887["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o38888 = temp__5455__auto____$1;
return (o38888["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__37997__auto__ = f;
return (o__37997__auto__["toString"]).call(o__37997__auto__);
} else {
return "";
}
}catch (e38889){var _ = e38889;
return "";
}});
...
try{var o__37997__auto___38891 = t;
(o__37997__auto___38891["cljs$lang$ctorPrWriter"]).call(o__37997__auto___38891,t,writer);
}catch (e38890){var __38892 = e38890;
}
...
var char_code = (function (){var o__37997__auto__ = (new String(char$));
return (o__37997__auto__["charCodeAt"]).call(o__37997__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37997__auto__ = String;
return (o__37997__auto__["fromCharCode"]).call(o__37997__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38893 = num_code;
switch (G__38893) {
case (1):
return (185);
...
var o__37997__auto__ = String;
return (o__37997__auto__["fromCharCode"]).call(o__37997__auto__,superscript_code);
});
/**
...
}catch (e38895){var _e__38004__auto__ = e38895;
return false;
}})())){
...
var vec__38896 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38896,(0),null);
...
var or__35498__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o38899 = temp__5455__auto__;
var temp__5455__auto____$1 = (o38899["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o38900 = temp__5455__auto____$1;
return (o38900["nameToPath"]);
} else {
return null;
}
} else {
...
var len__36777__auto___38907 = arguments.length;
var i__36778__auto___38908 = (0);
while(true){
if((i__36778__auto___38908 < len__36777__auto___38907)){
args__36784__auto__.push((arguments[i__36778__auto___38908]));

var G__38909 = (i__36778__auto___38908 + (1));
i__36778__auto___38908 = G__38909;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__36785__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38903){
var vec__38904 = p__38903;
var ns_detector = cljs.core.nth.call(null,vec__38904,(0),null);
var effective_detector = (function (){var or__35498__auto__ = ns_detector;
if(cljs.core.truth_(or__35498__auto__)){
return or__35498__auto__;
} else {
...
var G__38910 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38911 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38910;
remaining_tokens = G__38911;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38901){
var G__38902 = cljs.core.first.call(null,seq38901);
var seq38901__$1 = cljs.core.next.call(null,seq38901);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38902,seq38901__$1);
});
...
var vec__38915 = cljs.core.split_with.call(null,(function (p1__38914_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38914_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38915,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38915,(1),null);
...
var vec__38918 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38918,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38918,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38921 = cljs.core.rest.call(null,remaining_tokens);
var G__38922 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38921;
name_tokens = G__38922;
continue;
} else {
...
var vec__38925 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38925,(0),null);
var arity = cljs.core.nth.call(null,vec__38925,(1),null);
var vec__38928 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38928,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38928,(1),null);
var vec__38931 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38931,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38931,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38931,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38931,(3),null);
...
var vec__38937 = result;
var munged_ns = cljs.core.nth.call(null,vec__38937,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38937,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38937,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38937,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38937,(4),null);
var arity = cljs.core.nth.call(null,vec__38937,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__38941 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__38941,(0),null);
var args = cljs.core.nth.call(null,vec__38941,(1),null);
var vec__38944 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38944,(0),null);
var name = cljs.core.nth.call(null,vec__38944,(1),null);
...
var G__38947 = (arity + (1));
var G__38948 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38949){
var vec__38950 = p__38949;
var arity = cljs.core.nth.call(null,vec__38950,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38950,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__35498__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__35498__auto__)){
return or__35498__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__38953_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38954_SHARP_);
...
var args__36784__auto__ = [];
var len__36777__auto___38961 = arguments.length;
var i__36778__auto___38962 = (0);
while(true){
if((i__36778__auto___38962 < len__36777__auto___38961)){
args__36784__auto__.push((arguments[i__36778__auto___38962]));

var G__38963 = (i__36778__auto___38962 + (1));
i__36778__auto___38962 = G__38963;
continue;
} else {
}
break;
...
var argseq__36785__auto__ = ((((1) < args__36784__auto__.length))?(new cljs.core.IndexedSeq(args__36784__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__36785__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38957){
var vec__38958 = p__38957;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38958,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38955){
var G__38956 = cljs.core.first.call(null,seq38955);
var seq38955__$1 = cljs.core.next.call(null,seq38955);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38956,seq38955__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__35498__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__35498__auto__)){
return or__35498__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__35486__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__35498__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__35498__auto__)){
return or__35498__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__38966__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38966__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38966__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38966__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38967 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38967,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38967,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38967,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38967,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38967,(4),null);
var arity = cljs.core.nth.call(null,vec__38967,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__35486__auto__ = protocol_ns;
if(cljs.core.truth_(and__35486__auto__)){
return cljs.core.not.call(null,(function (){var and__35486__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__35498__auto__ = protocol_part;
if(cljs.core.truth_(or__35498__auto__)){
return or__35498__auto__;
} else {
return fn_part;
...
var o__37997__auto__ = f;
return (o__37997__auto__["getBasis"]).call(o__37997__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__35486__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__35486__auto__)){
...
}catch (e38971){var _e__38004__auto__ = e38971;
...
var G__38972 = (obj[cljs.core.first.call(null,path)]);
var G__38973 = cljs.core.rest.call(null,path);
obj = G__38972;
path = G__38973;
continue;
} else {
...
var partition_bits = (function (){var or__35498__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__35498__auto__)){
return or__35498__auto__;
} else {
return (0);
...
return (function (accum,p__38974){
var vec__38975 = p__38974;
var bit = cljs.core.nth.call(null,vec__38975,(0),null);
var protocol = cljs.core.nth.call(null,vec__38975,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38978){
var vec__38979 = p__38978;
var ns = cljs.core.nth.call(null,vec__38979,(0),null);
var name = cljs.core.nth.call(null,vec__38979,(1),null);
var selector = cljs.core.nth.call(null,vec__38979,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__38984,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__38984,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__38984,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__38982_SHARP_){
return (obj[cljs.core.first.call(null,p1__38982_SHARP_)]);
});})(name,sorted_matches,vec__38984,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1517021942278
