...
var G__38989 = devtools.prefs.pref.call(null,v);
v = G__38989;
continue;
} else {
return v;
...
var and__35486__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__35486__auto__){
var and__35486__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__35498__auto__ = (function (){try{if(!((value == null))){
...
}catch (e38992){var _e__38004__auto__ = e38992;
return false;
}})();
if(cljs.core.truth_(or__35498__auto__)){
return or__35498__auto__;
} else {
var or__35498__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e38996){var _e__38004__auto__ = e38996;
return false;
}})();
...
}catch (e38998){var _e__38004__auto__ = e38998;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__35486__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__35486__auto__)){
var and__35486__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__35486__auto____$1){
...
var and__35486__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__35486__auto__)){
...
var or__35498__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__35498__auto__)){
return or__35498__auto__;
} else {
...
var and__35486__auto__ = (function (){var or__35498__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__35498__auto__)){
return or__35498__auto__;
} else {
...
var vec__39000 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39000,(0),null);
var name = cljs.core.nth.call(null,vec__39000,(1),null);
...
var and__35486__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__35486__auto__)){
...
var or__35498__auto__ = typeof value === 'string';
if(or__35498__auto__){
return or__35498__auto__;
} else {
var or__35498__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__39003_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39003_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1517021942343
