...
var len__36777__auto___39009 = arguments.length;
var i__36778__auto___39010 = (0);
while(true){
if((i__36778__auto___39010 < len__36777__auto___39009)){
args__36784__auto__.push((arguments[i__36778__auto___39010]));

var G__39011 = (i__36778__auto___39010 + (1));
i__36778__auto___39010 = G__39011;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__36785__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq39007){
var G__39008 = cljs.core.first.call(null,seq39007);
var seq39007__$1 = cljs.core.next.call(null,seq39007);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__39008,seq39007__$1);
});
...
return (p1__39012_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1517021942368
