...
var len__36777__auto___39018 = arguments.length;
var i__36778__auto___39019 = (0);
while(true){
if((i__36778__auto___39019 < len__36777__auto___39018)){
args__36784__auto__.push((arguments[i__36778__auto___39019]));

var G__39020 = (i__36778__auto___39019 + (1));
i__36778__auto___39019 = G__39020;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__36785__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq39015){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__39016,G__39017,seq39015__$2);
});
...
if(cljs.core.truth_((function (){var or__35498__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__36169__auto__,writer__36170__auto__,opt__36171__auto__){
return cljs.core._write.call(null,writer__36170__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__35486__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__35486__auto__){
var or__35498__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__35498__auto__)){
return or__35498__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__39021_SHARP_){
return !((cljs.core.meta.call(null,p1__39021_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__39022__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__35498__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e39026){var _e__38004__auto__ = e39026;
return false;
}})();
if(cljs.core.truth_(or__35498__auto__)){
return or__35498__auto__;
...
}catch (e39028){var _e__38004__auto__ = e39028;
return false;
}}
})())){
...
var _STAR_current_state_STAR_39030 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__39031 = opts;
...
var markup_db = cljs.core.get.call(null,map__39031__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_39030;
}});
...
;
var temp__5455__auto___39035 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___39035)){
var managed_print_level_39036 = temp__5455__auto___39035;
var _STAR_print_level_STAR_39034_39037 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_39036;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_39034_39037,managed_print_level_39036,temp__5455__auto___39035,writer,opts,job_fn){
return (function (p1__39033_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__39033_SHARP_,null);
});})(_STAR_print_level_STAR_39034_39037,managed_print_level_39036,temp__5455__auto___39035,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_39034_39037;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1517021942427
